  ...
  return <div className='flex flex-col'>
    ...
    <div className='flex flex-row justify-between 2xl:justify-center h-body'>
      <div className='w-1/2 lg:pr-20 flex flex-col text-5xl items-end justify-center bg-primary pr-10 space-y-4'>
        ...
        <div>{t('services')}</div>
        <div className='pt-10'>
          <NavigationLink href={"/correction"} className='px-10 py-3 mr-10 w-52 border-2 border-black text-2xl font-light'>{tNav('correction')}</NavigationLink>
          <NavigationLink href={"/interpretariat"} className='px-10 py-3 w-52 border-2 border-black text-2xl font-light'>{tNav('interpretariat')}</NavigationLink>
        </div>
      </div>
