...
export default function CorrectionPage() {
  ...
  return <div className='flex flex-col min-h-body mb-10'>
    {/* First block */}
    ...
    <div className='w-full h-body px-20 flex flex-col'>
      ...
      <div className='flex justify-center'>
        <NavigationLink href={"/correction"} className='px-10 py-3 border-2 border-black text-2xl font-light'>{t('askForAFreeEstimate')}</NavigationLink>
      </div>
    </div>
  </div>;
}
